...
export const Home = () => {
  return (
    ...
    <Navbar/>
    <div  id="home" className="pl-10  bg-white relative lg: dark:bg-white h-screen" style={{background: `linear-gradient(90deg, rgba(255,255,255,1) 47%, rgba(128,240,253,1) 100%)`}} >
    <img src="logoo.jpg" width={730} className=' object-cover'  />
